...
banner = Figlet(font="whimsy").renderText("EVAN WARP")

print (text(banner))
print (Fore.RED + "[$] Created By EVAN DIPRO")
print (Fore.GREEN + "[$] Channel ~> @arenaofcrackersofficial")
print (Fore.LIGHTMAGENTA_EX + "[&] Warp Plus Unlimited ! ")
